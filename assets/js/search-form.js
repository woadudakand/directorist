/******/ (function () {
  ...
  \*********************************************/
		...
		/* harmony import */ var _global_components_select2_custom_control__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(
				/*! ./../global/components/select2-custom-control */ './assets/src/js/global/components/select2-custom-control.js'
			);
		/* harmony import */ var _global_components_select2_custom_control__WEBPACK_IMPORTED_MODULE_1___default =
			/*#__PURE__*/ __webpack_require__.n(
				_global_components_select2_custom_control__WEBPACK_IMPORTED_MODULE_1__
			);
		...
		/* harmony import */ var _components_category_custom_fields__WEBPACK_IMPORTED_MODULE_3__ =
			__webpack_require__(
				/*! ./components/category-custom-fields */ './assets/src/js/public/components/category-custom-fields.js'
			);
		/* harmony import */ var _components_colorPicker__WEBPACK_IMPORTED_MODULE_4__ =
			__webpack_require__(
				/*! ./components/colorPicker */ './assets/src/js/public/components/colorPicker.js'
			);
		/* harmony import */ var _components_colorPicker__WEBPACK_IMPORTED_MODULE_4___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_colorPicker__WEBPACK_IMPORTED_MODULE_4__
			);
          ...
          ------------------ */
						...
						$.ajax({
							...
							success: function success(response) {
								if (response) {
									...
									initSearchFields();
									(0,
									_components_category_custom_fields__WEBPACK_IMPORTED_MODULE_3__[
										'default'
									])($);
								}
				...
				function directorist_custom_range_slider() {
					...
					sliders.forEach(function (sliderItem) {
						...
						var sliderMinValue = parseInt(
							slider.getAttribute('min-value')
						);
						var sliderMaxValue = parseInt(
							slider.getAttribute('max-value')
						);
						...
						minInput.addEventListener('change', function () {
							var minValue =
								Math.round(
									parseInt(this.value, 10) / sliderStep
								) * sliderStep;
							var maxValue =
								Math.round(
									parseInt(maxInput.value, 10) / sliderStep
								) * sliderStep;
						...
						maxInput.addEventListener('change', function () {
							var minValue =
								Math.round(
									parseInt(minInput.value, 10) / sliderStep
								) * sliderStep;
							var maxValue =
								Math.round(
									parseInt(this.value, 10) / sliderStep
